function get_series_with_movies(data) {
    var result = [];


    data.forEach(series => {
        if(series.upcomming.movies.length > 0) {
            result.push(series);
        }
    });
...
function get_series_with_serials(data) {
    ...
    data.forEach(series => {
        if(series.upcomming.episodes.length > 0) {
            result.push(series);
        }
    });
...
function get_series_with_scenes(data) {
    var result = [];


    data.forEach(series => {
        if(series.upcomming.scenes.length > 0) {
            result.push(series);
        }
    });
...
function make_movies(data) {
    var element = document.getElementById("movies");

    element.innerHTML = get_series_with_movies(data).map((series, index) => {
        if (index % 2 === 0) {
            return `
                ${index > 0 ? "</div>" : ""}
                <div class="row py-2">
...
function make_serials(data) {
    var element = document.getElementById("serials");

    element.innerHTML = get_series_with_serials(data).map((series, index) => {
...
function make_scenes(data) {
    var element = document.getElementById("scenes");

    element.innerHTML = get_series_with_scenes(data).map((series, index) => {
        if (index % 2 === 0) {
            return `
                ${index > 0 ? "</div>" : ""}
                <div class="row py-2">
